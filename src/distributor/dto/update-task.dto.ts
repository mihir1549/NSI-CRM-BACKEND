...
export class UpdateTaskDto {
  @ApiPropertyOptional({ example: 'Follow up with Rajesh about membership', description: 'Task title (max 200 chars)' })
  @IsOptional()
  @IsString()
  @MaxLength(200)
  title?: string;
  ...
  @ApiPropertyOptional({ example: 'IN_PROGRESS', enum: ['TODO', 'IN_PROGRESS', 'COMPLETE'], description: 'Task status' })
  @IsOptional()
  @IsIn(['TODO', 'IN_PROGRESS', 'COMPLETE'])
  status?: string;

  @ApiPropertyOptional({ example: 0, description: 'Display order position', minimum: 0 })
  @IsOptional()
  @IsInt()
  @Min(0)
  order?: number;
