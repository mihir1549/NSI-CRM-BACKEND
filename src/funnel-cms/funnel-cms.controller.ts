...
export class FunnelCmsController {
  ...
  @ApiResponse({ status: 201, description: 'Section created', type: CmsSectionItem })
  @Post('sections')
  ...
  @ApiResponse({ status: 200, description: 'All sections', type: [CmsSectionWithStepsItem] })
  @Get('sections')
  getAllSections() {
  ...
  @ApiResponse({ status: 200, description: 'Sections reordered', type: CmsMessageResponse })
  @Patch('sections/reorder')
  reorderSections(@Body(new ParseArrayPipe({ items: ReorderItemDto })) items: ReorderItemDto[]) {
  ...
  @ApiResponse({ status: 200, description: 'Section edit data', type: CmsSectionUpdateResponse })
  ...
  @ApiParam({ name: 'uuid', description: 'Section UUID' })
  @ApiResponse({ status: 200, description: 'Section updated', type: CmsSectionItem })
  @ApiResponse({ status: 404, description: 'Section not found', type: ErrorResponse })
  @Patch('sections/:uuid')
  ...
  @ApiParam({ name: 'uuid', description: 'Section UUID' })
  @ApiResponse({ status: 200, description: 'Section deleted', type: CmsMessageResponse })
  @ApiResponse({ status: 400, description: 'Cannot delete (users active)', type: ErrorResponse })
  ...
  @ApiResponse({ status: 200, description: 'Steps reordered', type: CmsMessageResponse })
  @Patch('steps/reorder')
  reorderSteps(@Body(new ParseArrayPipe({ items: ReorderItemDto })) items: ReorderItemDto[]) {
    return this.cmsService.reorderSteps(items);
  }

  @ApiOperation({ summary: 'Get step data for editing' })
  @ApiParam({ name: 'uuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Step edit data', type: CmsStepUpdateResponse })
  @ApiResponse({ status: 404, description: 'Step not found', type: ErrorResponse })
  @Get('steps/:uuid/edit')
  ...
  @ApiParam({ name: 'uuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Step deleted', type: CmsMessageResponse })
  @ApiResponse({ status: 400, description: 'Cannot delete (users active)', type: ErrorResponse })
  @Delete('steps/:uuid')
  ...
  @ApiResponse({ status: 200, description: 'Step content edit data', type: CmsStepContent })
  ...
  @ApiParam({ name: 'stepUuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Content saved', type: CmsStepContent })
  @Patch('steps/:stepUuid/content')
  upsertContent(@Param('stepUuid') uuid: string, @Body() dto: UpdateStepContentDto) {
    return this.cmsService.upsertStepContent(uuid, dto);
  }

  @ApiOperation({ summary: 'Get PHONE_GATE config for editing' })
  @ApiParam({ name: 'stepUuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Phone gate edit data', type: CmsPhoneGate })
  ...
  @ApiParam({ name: 'stepUuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Phone gate saved', type: CmsPhoneGate })
  @Patch('steps/:stepUuid/phone')
  upsertPhoneGate(@Param('stepUuid') uuid: string, @Body() dto: UpdatePhoneGateDto) {
    return this.cmsService.upsertPhoneGate(uuid, dto);
  }

  @ApiOperation({ summary: 'Get PAYMENT_GATE config for editing' })
  @ApiParam({ name: 'stepUuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Payment gate edit data', type: CmsPaymentGate })
  ...
  @ApiParam({ name: 'stepUuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Payment gate saved', type: CmsPaymentGate })
  @Patch('steps/:stepUuid/payment')
  upsertPaymentGate(@Param('stepUuid') uuid: string, @Body() dto: UpdatePaymentGateDto) {
    return this.cmsService.upsertPaymentGate(uuid, dto);
  }

  @ApiOperation({ summary: 'Get DECISION config for editing' })
  @ApiParam({ name: 'stepUuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Decision step edit data', type: CmsDecisionStep })
  ...
  @ApiParam({ name: 'stepUuid', description: 'Step UUID' })
  @ApiResponse({ status: 200, description: 'Decision step saved', type: CmsDecisionStep })
  @Patch('steps/:stepUuid/decision')
  upsertDecisionStep(@Param('stepUuid') uuid: string, @Body() dto: UpdateDecisionStepDto) {
