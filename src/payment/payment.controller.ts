...
} from './dto/responses/payment.responses.js';
...
export class PaymentController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Order created with Razorpay order ID or free access',
    type: PaymentOrderResponse,
  })
  @ApiResponse({
    status: 400,
    description: 'Payment gate not configured',
    type: ErrorResponse,
  })
  @ApiResponse({
    status: 401,
  ...
  @ApiResponse({
    status: 403,
    description: 'Phone verification required / Need to reach step',
    type: ErrorResponse,
  })
  @ApiResponse({
    status: 409,
