...
export function getSubscriptionWarningTemplate(data: SubscriptionWarningData): {
  subject: string;
  html: string;
} {
  ...
  return {
    ...
    html: baseEmailTemplate({
      ...
      description:
        'We tried to charge your payment method but it was declined. Update your details to keep your access.',
      bodyContent,
      footerText:
        "You're receiving this because a payment issue was detected on your Growith NSI account.",
