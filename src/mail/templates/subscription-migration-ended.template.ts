...
export function getSubscriptionMigrationEndedTemplate(
  ...
  const formattedDeadline = new Date(data.graceDeadline).toLocaleDateString('en-IN', {
  ...
  return {
    subject: 'Your Growith NSI Distributor Plan Has Ended — 7 Days to Resubscribe',
    html: baseEmailTemplate({
      ...
      description: 'Your previous distributor plan has ended. You have 7 days to subscribe to the new plan.',
      bodyContent,
      footerText: "You're receiving this because your Growith NSI distributor plan has ended due to a plan change.",
