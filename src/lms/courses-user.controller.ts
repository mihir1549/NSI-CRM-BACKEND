...
export class CoursesUserController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Published courses with enrollment status',
    type: [CourseUserListResponse],
  })
  @Get('courses')
  ...
  @ApiOperation({
    summary: 'Get course learning content (requires enrollment)',
  })
  @ApiParam({ name: 'uuid', description: 'Course UUID' })
  @ApiResponse({
    status: 200,
    description: 'Course learn content',
    type: CourseUserLearnResponse,
  })
  @ApiResponse({
    status: 403,
  ...
  @ApiResponse({
    ...
    type: LessonLearnResponse,
  })
  @ApiResponse({
    status: 403,
    description: 'Not enrolled in parent course or lesson locked',
    type: ErrorResponse,
  })
  @ApiResponse({
    status: 404,
  ...
  updateLessonProgress(
    ...
    return this.userService.updateLessonProgress(
      lessonUuid,
      user.sub,
      dto.watchedSeconds,
    );
