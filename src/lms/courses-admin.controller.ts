...
import { ErrorResponse, DeletedResponse, ReorderedResponse } from '../common/dto/responses/error.response.js';
...
export class CoursesAdminController {
  ...
  @ApiResponse({ status: 201, description: 'Course created', schema: { type: 'object', properties: { uuid: { type: 'string' } } } })
  ...
  @ApiResponse({ status: 200, description: 'List of all courses', type: [CourseAdminListResponse] })
  @Get('courses')
  findAllCourses() {
  ...
  @ApiResponse({ status: 200, description: 'Course detail', type: CourseAdminDetailResponse })
  ...
  @ApiParam({ name: 'uuid', description: 'Course UUID' })
  @ApiResponse({ status: 200, description: 'Course edit data', type: CourseAdminUpdateResponse })
  @ApiResponse({ status: 404, description: 'Course not found', type: ErrorResponse })
  ...
  @ApiParam({ name: 'uuid', description: 'Course UUID' })
  @ApiResponse({ status: 200, description: 'Course updated', schema: { type: 'object', properties: { uuid: { type: 'string' } } } })
  @ApiResponse({ status: 404, description: 'Course not found', type: ErrorResponse })
  @Patch('courses/:uuid')
  ...
  @ApiParam({ name: 'uuid', description: 'Course UUID' })
  @ApiResponse({ status: 200, description: 'Course deleted', type: DeletedResponse })
  @ApiResponse({ status: 400, description: 'Cannot delete course with active enrollments', type: ErrorResponse })
  @ApiResponse({ status: 404, description: 'Course not found', type: ErrorResponse })
  @Delete('courses/:uuid')
  ...
  @ApiParam({ name: 'uuid', description: 'Course UUID' })
  @ApiResponse({ status: 200, description: 'Course published', schema: { type: 'object', properties: { uuid: { type: 'string' } } } })
  @ApiResponse({ status: 404, description: 'Course not found', type: ErrorResponse })
  ...
  @ApiParam({ name: 'uuid', description: 'Course UUID' })
  @ApiResponse({ status: 200, description: 'Course unpublished', schema: { type: 'object', properties: { uuid: { type: 'string' } } } })
  @ApiResponse({ status: 404, description: 'Course not found', type: ErrorResponse })
  ...
  @ApiParam({ name: 'uuid', description: 'Course UUID' })
  @ApiResponse({ status: 201, description: 'Section created', schema: { type: 'object', properties: { uuid: { type: 'string' } } } })
  @ApiResponse({ status: 404, description: 'Course not found', type: ErrorResponse })
  ...
  @ApiResponse({ status: 200, description: 'Sections reordered', type: ReorderedResponse })
  @ApiResponse({ status: 404, description: 'Course not found', type: ErrorResponse })
  ...
  @ApiResponse({ status: 200, description: 'Section edit data', type: SectionAdminUpdateResponse })
  @ApiResponse({ status: 404, description: 'Section not found', type: ErrorResponse })
  ...
  @ApiParam({ name: 'courseUuid', description: 'Course UUID' })
  @ApiParam({ name: 'sectionUuid', description: 'Section UUID' })
  @ApiResponse({ status: 200, description: 'Section updated', schema: { type: 'object', properties: { uuid: { type: 'string' } } } })
  @ApiResponse({ status: 404, description: 'Section not found', type: ErrorResponse })
  ...
  @ApiParam({ name: 'courseUuid', description: 'Course UUID' })
  @ApiParam({ name: 'sectionUuid', description: 'Section UUID' })
  @ApiResponse({ status: 200, description: 'Section deleted', type: DeletedResponse })
  @ApiResponse({ status: 404, description: 'Section not found', type: ErrorResponse })
  ...
  @ApiParam({ name: 'courseUuid', description: 'Course UUID' })
  @ApiParam({ name: 'sectionUuid', description: 'Section UUID' })
  @ApiResponse({ status: 201, description: 'Lesson created', schema: { type: 'object', properties: { uuid: { type: 'string' } } } })
  @ApiResponse({ status: 404, description: 'Section not found', type: ErrorResponse })
  ...
  @ApiParam({ name: 'courseUuid', description: 'Course UUID' })
  @ApiParam({ name: 'sectionUuid', description: 'Section UUID' })
  @ApiResponse({ status: 200, description: 'Lessons reordered', type: ReorderedResponse })
  @ApiResponse({ status: 404, description: 'Section not found', type: ErrorResponse })
  ...
  @ApiResponse({ status: 200, description: 'Lesson edit data', type: LessonAdminUpdateResponse })
  ...
  @ApiParam({ name: 'sectionUuid', description: 'Section UUID' })
  @ApiParam({ name: 'lessonUuid', description: 'Lesson UUID' })
  @ApiResponse({ status: 200, description: 'Lesson updated', schema: { type: 'object', properties: { uuid: { type: 'string' } } } })
  @ApiResponse({ status: 404, description: 'Lesson not found', type: ErrorResponse })
  ...
  @ApiParam({ name: 'sectionUuid', description: 'Section UUID' })
  @ApiParam({ name: 'lessonUuid', description: 'Lesson UUID' })
  @ApiResponse({ status: 200, description: 'Lesson deleted', type: DeletedResponse })
  @ApiResponse({ status: 404, description: 'Lesson not found', type: ErrorResponse })
  ...
  @ApiResponse({ status: 200, description: 'LMS analytics data', type: LmsAnalyticsResponse })
  @Get('lms/analytics')
  getLmsAnalytics() {
