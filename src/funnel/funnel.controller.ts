...
export class FunnelController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Funnel structure',
    type: FunnelStructureResponse,
  })
  @Get('structure')
  getStructure() {
  ...
  @ApiResponse({
    status: 200,
    description: 'User funnel progress',
    type: FunnelProgressResponse,
  })
  @Get('progress')
  ...
  @ApiResponse({
    status: 400,
    description: 'Must complete previous steps',
    type: ErrorResponse,
  })
  @ApiResponse({
    status: 404,
  ...
  @ApiResponse({
    ...
    type: FunnelActionResponse,
  })
  @ApiResponse({
    status: 400,
    description: 'Validation or sequential error',
    type: ErrorResponse,
  })
  @ApiResponse({
    status: 404,
  ...
  saveVideoProgress(
    ...
    const user = req.user as JwtPayload;
    return this.funnelService.saveVideoProgress(
      user.sub,
      stepUuid,
      dto.watchedSeconds,
    );
